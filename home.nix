...

{
  ...
  programs.zsh = {
    ...
    initContent = let ZshExtraFirstConfig = lib.mkOrder 500 ''
    ...
    in lib.mkMerge [ ZshExtraFirstConfig zhsConfig ];

    shellAliases = {
      ll = "ls -l";
      update = "sudo nixos-rebuild switch --flake ~/nixos-dotfiles#duanos-luks";
